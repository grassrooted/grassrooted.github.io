...
def extract_finance_data_from_table(pdf_path):
    ...
    def parse_header_page(table):
        ...
        [period_start, period_end] = period_covered.split("_")
...
def process_pdfs_from_links(related_tec_docs_filename, output_dir=f"downloaded_pdfs_{FIRST_NAME_CONFIG}_{LAST_NAME_CONFIG}"):
    ...
    for link in links:
        ...
        if pdf_path:
            ...
            finance_data["candidate_info"]["data_source"] = link
            ...
            period_covered = finance_data["candidate_info"]["period_start"] + "_" + finance_data["candidate_info"]["period_end"]
